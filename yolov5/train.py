...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='/opt/ml/detection/yolov5/data/trash_10.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.finetune_custom.yaml', help='hyperparameters path')
